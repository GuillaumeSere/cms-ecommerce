                ...
                <div className="row">
                        ...
                        <div className='filter-card mb-3'>
                            ...
                            <div>
                                <div className="random-products d-flex">
                                    <div className="w-50">
                                        <img src="../images/acc.jpg" className='img-fluid' alt="watch" />
                                    </div>
                                    <div className="w-50">
                                ...
                                <div className="random-products d-flex">
                                    ...
                                    <div className="w-50">
                                        <h5>Shop the latest band styles and colors</h5>
                                        <ReactStars
                                            count={5}
                                            size={24}
                                            activeColor="#ffd700"
                    ...
                    <div className="col-9">
                            ...
                            <div className="d-flex justify-content-between align-items-center">
                                <div className="d-flex align-items-center gap-10">
                                    ...
                                    <select name="" className='form-control form-select' id="">
                                        ...
                                        <option value="price-accending">Price, low to hight</option>
                                ...
                                <div className='d-flex align-items-center gap-10'>
                                    <p className="totalproducts m-2">21 Products</p>
                        ...
                        <div className="products-list pb-5">
                            <div className="d-flex pb-5 gap-30">
