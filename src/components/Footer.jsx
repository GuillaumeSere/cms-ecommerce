                    ...
                    <div className="row">
                        <div className="col-4">
                            ...
                            <div>
                                ...
                                <a href="tel:+91 85469864" className="mt-3 d-block mb-2 text-white">+91 85469864</a>
                                <a href="mailto:example@gmail.com" className="mt-2 d-block mb-2 text-white">
                                    example@gmail.com
                                </a>
                ...
                <div className="container-xxl">
                    <div className="row">
                        <div className="col-12">
                            <p className="text-center mb-0 text-white">&copy; {new Date().getFullYear()}; Powered by Developer's React</p>
                        </div>
                    </div>
                </div>
            </footer>
